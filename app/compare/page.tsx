              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    {comparisonData.map(m => (
                      <td key={m.id} className="px-4 py-3 text-center font-medium">
                        {m.safety_score !== null && m.safety_score !== undefined ? `${m.safety_score.toFixed(1)}/100` : 'N/A'}
                      </td>
                    ))}
                  </tr>
                  <tr className="border-b border-gray-200">
                    ...
                    {comparisonData.map(m => (
                      <td key={m.id} className="px-4 py-3 text-center font-medium">
                        {m.school_rating !== null && m.school_rating !== undefined ? `${m.school_rating.toFixed(1)}/100` : 'N/A'}
                      </td>
                    ))}
                  </tr>
                  <tr className="border-b border-gray-200">
                    ...
                    {comparisonData.map(m => (
                      <td key={m.id} className="px-4 py-3 text-center font-medium">
                        {m.price_per_sqm !== null && m.price_per_sqm !== undefined ? m.price_per_sqm.toLocaleString('sv-SE') : 'N/A'}
                      </td>
                    ))}
                  </tr>
                  <tr className="border-b border-gray-200">
                    ...
                    {comparisonData.map(m => (
                      <td key={m.id} className="px-4 py-3 text-center font-medium">
                        {m.employment_rate !== null && m.employment_rate !== undefined ? `${m.employment_rate.toFixed(1)}%` : 'N/A'}
                      </td>
                    ))}
                  </tr>
