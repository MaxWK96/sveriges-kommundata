  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-2xl">Loading municipalities...</div>
      </div>
    )
  }
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4">Swedish Municipalities</h1>
        <p className="text-xl text-gray-600">
          Compare safety, education, housing prices, and foreign background data for Sweden's {municipalities.length} municipalities
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Safety: {safetyRange[0]} - {safetyRange[1]} / 100
            </label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              School Rating: {schoolRange[0]} - {schoolRange[1]} / 100
            </label>
            <div className="flex gap-2">
              <input
                type="range"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Employment: {employmentRange[0]} - {employmentRange[1]}%
            </label>
            <div className="flex gap-2">
              <input
                type="range"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Housing Price: {priceRange[0].toLocaleString()} - {priceRange[1].toLocaleString()} SEK/m²
            </label>
            <div className="flex gap-2">
              <input
                type="range"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Foreign Background: {foreignBackgroundRange[0]} - {foreignBackgroundRange[1]}%
            </label>
            <div className="flex gap-2">
              <input
                type="range"
            ...
            <div className="space-y-2 text-sm">
              ...
              {municipality.price_per_sqm !== null && municipality.price_per_sqm !== undefined && (
                <p className="flex justify-between">
                  ...
                  <span className="font-semibold">{municipality.price_per_sqm.toLocaleString()} SEK/m²</span>
                </p>
              )}
